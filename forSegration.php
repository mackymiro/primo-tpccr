  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">for segration</li>
      </ol>
    </section>
        ...
        <div class="col-md-6">
            <div class="box box-primary">
              <div class="box-header with-border">
                   ...
                   <a href="approvedfiles.php" >Back to main directory</a>
                  <?php
					require_once "conn.php";	
					...
					if(!empty($getFilePath)){
						
			
						$getFilePaths = "SELECT * FROM TPCCR_INVENTORY WHERE (ProductType != 'Inventory' AND ProductType != 'Specs') AND  RefId=".$getFilePath;
